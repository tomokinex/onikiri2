...
#ifndef EMU_RISCV64LINUX_RISCV64LINUX_SYSCALL_CONV_H
#define EMU_RISCV64LINUX_RISCV64LINUX_SYSCALL_CONV_H
...
namespace Onikiri {
    ...
    namespace RISCV64Linux {
        ...
        public:
            RISCV64LinuxSyscallConv(EmulatorUtility::ProcessState* processState);
            virtual ~RISCV64LinuxSyscallConv();
